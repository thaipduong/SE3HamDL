...
from se3hamneuralode import compute_rotation_matrix_from_quaternion, from_pickle, RnHamNODE
...
def get_model():
    model = RnHamNODE(device=device, u_dim=1).to(device)
    path = './data_500/pendulum-Rnham-rk4-5p.tar'
    model.load_state_dict(torch.load(path, map_location=device))
    path = './data_500/pendulum-Rnham-rk4-5p-stats.pkl'
