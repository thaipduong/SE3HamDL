...
THIS_DIR = os.path.dirname(os.path.abspath(__file__)) + '/data_500_dV'
PARENT_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
sys.path.append(PARENT_DIR)

from se3hamneuralode import MLP, PSD
from se3hamneuralode import RnHamNODEdV
...
def train(args):
    ...
    model = RnHamNODEdV(device=device, x_dim=1, u_dim = 1, init_gain=0.1).to(device)
